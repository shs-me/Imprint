...
class Config:
    ...
    class ShmSharing:
        ...
        class Footprint:
            ...
            class HeadersInt(IntEnum):
                Open, High, Low, Close = 0, 1, 2, 3
                Time, Volume, Delta, CountTrade = 4, 5, 6, 7

            coords_count = 6

            class CoordsInt(IntEnum):
                idy_min, idx_min, idy_max, idx_max, idy, idx = 0, 1, 2, 3, 4, 5
            ...
            flag_spare: int = flag
            shm_size: int = ((flag_spare // 4096) + 1) * 4096
        ...
        class Metrics:
            ...
            # general
            time_to_sleep: tuple[int, int] = qtyPrecision[1], qtyPrecision[1] + int64
            shm_size: int = ((time_to_sleep[1] // 4096) + 1) * 4096
