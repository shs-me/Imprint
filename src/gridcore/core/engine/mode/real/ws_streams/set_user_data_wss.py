...
class SetUserDataWSSAgent(Wss):
    ...
    def __init__(self, manager: AgentManager, wss_sem: Semaphore) -> None:
...
@supervisor()
def run_set_user_data_wss(wss_sem: Semaphore, **kwargs) -> None:
    """Supervisor-wrapped entry point launching live Wss process."""

    agent = SetUserDataWSSAgent(kwargs["manager"], wss_sem=wss_sem)
