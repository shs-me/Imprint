...
from ...base import base_account_manager as am
from . import matching_engine_sim as me

EquityT, EquityO, EquityH, EquityL, EquityC = 0, 1, 2, 3, 4


class ExchangeSim(am.BaseAccountManager, me.MatchingEngine):
    """Account state manager extending MatchingEngine with balance tracking and equity history."""

    def __init__(self, manager: AgentManager) -> None:
        am.BaseAccountManager.__init__(self, manager)
