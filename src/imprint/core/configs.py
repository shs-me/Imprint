...
class Account(Configuration):
    ...
    taker_commission: pct = field(default_factory=lambda: pct(0.05))
    maker_commission: pct = field(default_factory=lambda: pct(0.02))
    slippage: pct = field(default_factory=lambda: pct(0.05))
    latency_ms: int = 100
    scale_prec: int = 15
...
class RiskManagement(Configuration):
    max_lock_balance: pct = field(default_factory=lambda: pct(10))
    max_loss_balance: pct = field(default_factory=lambda: pct(10))
    entry_qty: pct = field(default_factory=lambda: pct(1))
    tp_dev: pct = field(default_factory=lambda: pct(5))
    sl_dev: pct = field(default_factory=lambda: pct(5))
